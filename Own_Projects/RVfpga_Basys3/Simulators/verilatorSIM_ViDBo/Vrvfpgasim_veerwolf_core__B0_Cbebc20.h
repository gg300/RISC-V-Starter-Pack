...
VL_MODULE(Vrvfpgasim_veerwolf_core__B0_Cbebc20) {
  public:
    ...
    struct {
        ...
        CData/*2:0*/ __PVT__syscon__DOT__SegDispl_Ctr__DOT__counter18__DOT__i_counter__DOT__counter_q;
        CData/*2:0*/ __PVT__syscon__DOT__SegDispl_Ctr__DOT__counter18__DOT__i_counter__DOT__counter_d;
