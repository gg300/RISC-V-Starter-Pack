...
VL_MODULE(Vrvfpgasim_wb_mem_wrapper__M1000_I0) {
  ...
  public:
    static void _sequent__TOP__rvfpgasim__veerwolf__bootrom__2(Vrvfpgasim__Syms* __restrict vlSymsp);
    static void _settle__TOP__rvfpgasim__veerwolf__bootrom__1(Vrvfpgasim__Syms* __restrict vlSymsp);
  private:
