...
void Vrvfpgasim_veerwolf_core__B0_Cbebc20::_ctor_var_reset() {
    ...
    __PVT__syscon__DOT__SegDispl_Ctr__DOT__counter18__DOT__i_counter__DOT__counter_q = VL_RAND_RESET_I(3);
    __PVT__syscon__DOT__SegDispl_Ctr__DOT__counter18__DOT__i_counter__DOT__counter_d = VL_RAND_RESET_I(3);
