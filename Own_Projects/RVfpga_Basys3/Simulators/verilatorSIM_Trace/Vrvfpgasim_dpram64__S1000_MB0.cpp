...
VL_INLINE_OPT void Vrvfpgasim_dpram64__S1000_MB0::_sequent__TOP__rvfpgasim__veerwolf__bootrom__ram__1(Vrvfpgasim__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vrvfpgasim_dpram64__S1000_MB0::_sequent__TOP__rvfpgasim__veerwolf__bootrom__ram__1\n"); );
    ...
    vlSymsp->TOP__rvfpgasim__veerwolf__bootrom__ram.__PVT__dout 
        ...
        [(0x1ffU & ((IData)(vlSymsp->TOP__rvfpgasim__veerwolf.__PVT__wb_adr) 
                    >> 1U))];
    if ((1U & (IData)(vlSymsp->TOP__rvfpgasim__veerwolf__bootrom.__PVT__mem_we))) {
    ...
    if ((2U & (IData)(vlSymsp->TOP__rvfpgasim__veerwolf__bootrom.__PVT__mem_we))) {
    ...
    if ((4U & (IData)(vlSymsp->TOP__rvfpgasim__veerwolf__bootrom.__PVT__mem_we))) {
    ...
    if ((8U & (IData)(vlSymsp->TOP__rvfpgasim__veerwolf__bootrom.__PVT__mem_we))) {
        __Vdlyvval__mem__v3 = (0xffU & (vlSymsp->TOP__rvfpgasim__veerwolf.__PVT__wb_m2s_io_dat 
                                        >> 0x18U));
    ...
    if ((0x10U & (IData)(vlSymsp->TOP__rvfpgasim__veerwolf__bootrom.__PVT__mem_we))) {
    ...
    if ((0x20U & (IData)(vlSymsp->TOP__rvfpgasim__veerwolf__bootrom.__PVT__mem_we))) {
    ...
    if ((0x40U & (IData)(vlSymsp->TOP__rvfpgasim__veerwolf__bootrom.__PVT__mem_we))) {
    ...
    if ((0x80U & (IData)(vlSymsp->TOP__rvfpgasim__veerwolf__bootrom.__PVT__mem_we))) {
        __Vdlyvval__mem__v7 = (0xffU & (vlSymsp->TOP__rvfpgasim__veerwolf.__PVT__wb_m2s_io_dat 
                                        >> 0x18U));
    ...
    if (__Vdlyvset__mem__v0) {
        vlSymsp->TOP__rvfpgasim__veerwolf__bootrom__ram.mem[__Vdlyvdim0__mem__v0] 
    ...
    if (__Vdlyvset__mem__v1) {
        vlSymsp->TOP__rvfpgasim__veerwolf__bootrom__ram.mem[__Vdlyvdim0__mem__v1] 
    ...
    if (__Vdlyvset__mem__v2) {
        vlSymsp->TOP__rvfpgasim__veerwolf__bootrom__ram.mem[__Vdlyvdim0__mem__v2] 
    ...
    if (__Vdlyvset__mem__v3) {
        vlSymsp->TOP__rvfpgasim__veerwolf__bootrom__ram.mem[__Vdlyvdim0__mem__v3] 
    ...
    if (__Vdlyvset__mem__v4) {
        vlSymsp->TOP__rvfpgasim__veerwolf__bootrom__ram.mem[__Vdlyvdim0__mem__v4] 
    ...
    if (__Vdlyvset__mem__v5) {
        vlSymsp->TOP__rvfpgasim__veerwolf__bootrom__ram.mem[__Vdlyvdim0__mem__v5] 
    ...
    if (__Vdlyvset__mem__v6) {
        vlSymsp->TOP__rvfpgasim__veerwolf__bootrom__ram.mem[__Vdlyvdim0__mem__v6] 
    ...
    if (__Vdlyvset__mem__v7) {
        vlSymsp->TOP__rvfpgasim__veerwolf__bootrom__ram.mem[__Vdlyvdim0__mem__v7] 
