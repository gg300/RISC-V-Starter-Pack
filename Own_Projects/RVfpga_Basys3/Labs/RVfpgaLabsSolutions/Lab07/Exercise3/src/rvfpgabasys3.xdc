...
set_property PACKAGE_PIN U18 [get_ports {i_pb[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {i_pb[0]}]
#Bank = 14, Pin name = ,					Sch name = BTNU
set_property PACKAGE_PIN T18 [get_ports {i_pb[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {i_pb[1]}]
#Bank = 14, Pin name = ,	Sch name = BTNL
set_property PACKAGE_PIN W19 [get_ports {i_pb[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {i_pb[2]}]
#Bank = 14, Pin name = ,							Sch name = BTNR
set_property PACKAGE_PIN T17 [get_ports {i_pb[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {i_pb[3]}]
#Bank = 14, Pin name = ,					Sch name = BTND
set_property PACKAGE_PIN U17 [get_ports {i_pb[4]}]
set_property IOSTANDARD LVCMOS33 [get_ports {i_pb[4]}]
